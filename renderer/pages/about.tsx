...
const AboutPage = () => {
  return (
    <Layout contentStyles={{ height: "100vh" }}>
      ...
      <Screenshot src={"/static/images/add_game.png"} />
      <Description>2. Choose ".exe" file folder and save file location</Description>
      <Screenshot src={"/static/images/add_game_2.png"} />
      <Description>3. Check settings</Description>
      <Screenshot src={"/static/images/settings.png"} />
      ...
      <Screenshot src={"/static/images/game.png"} />
    </Layout>
  );
};
